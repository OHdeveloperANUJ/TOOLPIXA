    ...
    >
      <head>
        ...
        <link 
          ...
          rel="stylesheet" 
          href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200&icon_names=123,account_balance,account_balance_wallet,add,analytics,arrow_back,arrow_forward,article,aspect_ratio,auto_stories,bolt,briefcase,broken_image,build,calculate,check,check_circle,chevron_right,close,code,compress,cookie,crop,dark_mode,data_object,delete_forever,description,device_thermostat,directions_car,dns,domain,edit_document,encrypted,event,favorite,fitness_center,format_list_bulleted,format_list_numbered,gavel,grid_view,health_and_safety,history,home,home_max,home_work,image,indian_rupee,info,ios_share,keyboard_arrow_down,light_mode,link,mail,menu_book,monitor_heart,monitoring,movie,open_in_new,park,payments,percent,person,photo_library,photo_size_select_large,picture_as_pdf,public,receipt,receipt_long,rotate_right,savings,scale,schedule,school,science,search,search_off,security,sell,set_meal,share,shopping_bag,speed,star,straighten,swap_calls,swap_horiz,sync_alt,timer,trending_down,trending_up,two_wheeler,verified,verified_user,view_list,warning,water_drop,youtube&display=swap" 
          media="print"
        />
