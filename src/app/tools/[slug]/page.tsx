...
const calculators = {
  ...
  'home-loan-emi': dynamic(() => import('@/components/tools/HomeLoanEmi')),
  ...
  'compound-interest': dynamic(() => import('@/components/tools/CompoundInterestCalculator')),
  'fd-rd-calculator': dynamic(() => import('@/components/tools/FdRdCalculator')),
  'bmr-tdee-calculator': dynamic(() => import('@/components/tools/BmrCalculator')),
  ...
  'gst-vat-calculator': dynamic(() => import('@/components/tools/GstVatCalculator')),
