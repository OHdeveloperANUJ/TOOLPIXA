...
export const metadata = {
    title: "Contact Us | ToolPixa",
    description: "Read the Contact Us of ToolPixa.",
};
...
<h1 className="font-display-lg text-display-lg text-gradient mb-sm tracking-tight">Contact Us</h1>
