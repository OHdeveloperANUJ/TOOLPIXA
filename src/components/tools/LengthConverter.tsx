...
export default function LengthConverter() {
  ...
  const [fromUnit, setFromUnit] = useState<keyof typeof units>('meters');
  const [toUnit, setToUnit] = useState<keyof typeof units>('feet');
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full bg-white/5 border border-white/10 rounded-xl p-4 text-white focus:outline-none focus:ring-2 focus:ring-indigo-500/50 transition-all text-lg font-medium"
          ...
          <div className="flex items-center gap-4">
            <div className="flex-1 space-y-2">
              ...
              <select
                ...
                className="w-full bg-white/5 border border-white/10 rounded-xl p-4 text-white focus:outline-none focus:ring-2 focus:ring-indigo-500/50 transition-all appearance-none cursor-pointer"
              >
