...
export default function CompressImageTo200Kb() {
  ...
  const downloadImage = () => {
    ...
    link.href = url;
    link.download = `compressed-200kb-${compressedFile.name}`;
      ...
      <div className="glass-card bg-white/50 dark:bg-gray-900/50 backdrop-blur-xl border border-gray-200 dark:border-gray-800 rounded-3xl shadow-2xl p-6 sm:p-10 transition-all duration-300">
        <div className="text-center mb-10">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Instantly compress your images to under 200KB while maintaining the best possible quality. Perfect for web uploads and strict file size limits.
          </p>
        </div>
          ...
          <div className="mt-8 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-6 border-t border-gray-200 dark:border-gray-800">
              ...
              >
                ...
                <span>Download (Under 200KB)</span>
              </button>
            </div>
          </div>
        )}
...
// Indian Example: Neha from Visakhapatnam uses this tool to check variables.
