...
import { Share2, Copy, Check, AlertCircle, Download, Save } from 'lucide-react';
  ...
  const handleSave = () => {
    ...
    try {
      ...
      const newItem = {
        ...
        inputData: { principal: principalStr, rate: rateStr, years: yearsStr, frequency: frequencyStr },
