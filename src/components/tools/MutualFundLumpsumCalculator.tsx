  ...
  const handleSave = () => {
    ...
    try {
      ...
      const newItem = {
        ...
        toolId: 'mutual-fund-lumpsum',
        inputData: { investment, returnRate, years },
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-xl items-start">
      ...
      <div className="glass-card p-xl rounded-xl space-y-md fade-in-up">
        <div className="flex justify-between items-center mb-sm">
          <h3 className="font-headline-md text-headline-md text-text-primary">Lumpsum Investment Details</h3>
          <button 
            onClick={handleSave} 
            disabled={isSaving || investment <= 0 || returnRate < 0 || years <= 0}
